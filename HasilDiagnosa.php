    ...
    <h4><span class='icon-dashboard'></span> Hasil Diagnosa - Tanaman Kopi</h4>
<?php 
...
<div class="alert">
    ...
    <p></p>
        <div class="alert alert-error"><b><?php echo $data['JnsPnykt']; ?></b></div>
    ...
    <p></p>
    <div class="alert alert-info"><?php echo $persentase; ?> % dari total gejala  <?php echo $data['JnsPnykt']; ?> yaitu ada 
        <?php 
    ...
    <div class="alert alert-success">
		...
		$j++;
			echo "<li>$hsl_solusi[solusi] </li>";
		}
		?>
        </ol>
    </div>
    
    <h4>Gejala yang dipilih tetapi bukan gejala  <?php echo $data['JnsPnykt']; ?> yaitu: </h4>
    <p></p>
    <div class="alert alert-info">
        <?php
...
$qry_solusi4 = mysql_query($sql_solusi3, $koneksi);
    ...
    <div class="alert alert-info">
	    ...
	    <div class="alert alert-error"><?php echo $persentase; ?> % dari total gejala  <?php echo $pn['JnsPnykt']; ?> yaitu ada 
	        <?php 
	                //select * from relasi where id_penyakit='".$id_penyakit."'
